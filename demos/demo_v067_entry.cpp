/**
 * @file demo_v067_entry.cpp
 * @brief Release 0.67 Demo Entry Point Implementation
 */
...
static V067DemoApp* g_demoApp = nullptr;
...
void demo_setup() {
    ...
    Serial.println("\n\n\n=== LPad Release 0.67 Demo Application ===");
    ...
    // [5/5] Create V067DemoApp
    Serial.println("[5/5] Creating V067DemoApp...");
    Serial.flush();

    static V067DemoApp demoApp;
    g_demoApp = &demoApp;

    if (!g_demoApp->begin(g_relativeDisplay)) {
        displayError("V067DemoApp initialization failed");
        while (1) delay(1000);
    }

    Serial.println("  [PASS] V067DemoApp initialized");
    Serial.println();

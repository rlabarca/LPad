...
- **Visual State Tracking:**
    - **Active:** The currently connected network is displayed in `THEME_TEXT_HIGHLIGHT` (Chamoisee).
    - **Connecting:** When an entry is tapped:
        - Background color alternates between `THEME_BG_CONNECTING` (Forest) and transparent.
        - **Blink Rate:** 0.75 seconds.

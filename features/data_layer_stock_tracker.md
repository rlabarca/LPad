...
- **And** the `DataItemTimeSeries` should be initialized with a buffer capacity large enough to hold at least 6 hours of 1-minute data (minimum 360 points, recommended 400).
...
- **Data Parsing & Management:**
  ...
  - **Buffer Management:** The `DataItemTimeSeries` must be statically or dynamically allocated with sufficient size to hold 6 hours of 1-minute data (approx 360-400 points).

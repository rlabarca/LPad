# Feature: Agent Instructions - Architect (Gemini)
...
## 1. Overview
Defines the operational mandate, core responsibilities, and procedural protocols for the Architect agent (Gemini).

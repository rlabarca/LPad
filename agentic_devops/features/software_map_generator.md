...
*   **Cycle Detection:** Must identify and flag circular dependencies (e.g., A -> B -> A).
*   **Mermaid Export:** Generates `feature_graph.mmd` for documentation.
*   **Interactive View:** Serves an HTML interface with a filterable, searchable tree of features.
...
### Scenario: Update Feature Graph
    ...
    Then the `feature_graph.mmd` is updated
    And the new feature appears in the interactive web view

...
**CURRENT CONTEXT:**
We are bootstrapping the project.
* **Target:** ESP32-S3-Touch-AMOLED (ESP-IDF via PlatformIO).
* **Current Task:** `features/display_baseline.md` (Porting vendor drivers to HAL).
* **Immediate Goal:** Ensure the Feature File is so precise that Claude cannot fail to port the vendor code correctly.

...
graph TD
    ...
    subgraph Data_Layer ["<span class='subgraph-title'>Data Layer</span>"]
        direction TB
    ...
    subgraph Release ["<span class='subgraph-title'>Release</span>"]
        direction TB
        demo_release_0_58("**Release v0.58: Dynamic Visuals**<br/><small>demo_release_0.58.md</small>"):::release
    end

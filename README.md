...
graph TD
    ...
    style Application_Layer font-size:20px,font-weight:bold
    style Board_Drivers font-size:20px,font-weight:bold
    style Graphics_Engine font-size:20px,font-weight:bold
    style Hardware_Layer font-size:20px,font-weight:bold
    style Release_Demos font-size:20px,font-weight:bold
    style Releases font-size:20px,font-weight:bold
    style UI_Framework font-size:20px,font-weight:bold

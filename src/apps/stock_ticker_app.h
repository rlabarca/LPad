...
#ifdef UNIT_TEST
public:
    StockTracker* getTrackerForTest() const { return m_stockTracker; }
    int getLastRenderedFetchStatusForTest() const { return m_lastRenderedFetchStatus; }
    long getLastDataTimestampForTest() const { return m_lastDataTimestamp; }
    bool isBackgroundDrawnForTest() const { return m_backgroundDrawn; }
#endif
};

...
#include "generated/lpad_version.h"
...
void setup() {
    ...
    Serial.println("\n\n\n=== LPad v" LPAD_VERSION " (Power States) ===");
    Serial.flush();
    yield();
    ...
    g_systemMenu->setVersion("Version " LPAD_VERSION);

...
// ==========================================
// Scenario: Component type reporting
// ==========================================

void test_app_component_reports_correct_type() {
    MockApp app(1);
    TEST_ASSERT_EQUAL(static_cast<int>(UIComponent::Type::APP),
                      static_cast<int>(app.getComponentType()));
}

void test_system_component_reports_correct_type() {
    MockSystem sys(10);
    TEST_ASSERT_EQUAL(static_cast<int>(UIComponent::Type::SYSTEM),
                      static_cast<int>(sys.getComponentType()));
}
...
int main(int argc, char** argv) {
    ...
    // Component type reporting
    RUN_TEST(test_app_component_reports_correct_type);
    RUN_TEST(test_system_component_reports_correct_type);

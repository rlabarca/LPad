...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="SVG to C++ Vector Asset Converter")
    parser.add_argument('--assets-dir', type=Path, default=None,
                        help="Directory containing SVG files (default: <project_root>/assets)")
    parser.add_argument('--output-dir', type=Path, default=None,
                        help="Output directory for generated C++ files (default: <project_root>/src/generated)")
    ...
    assets_dir = args.assets_dir if args.assets_dir is not None else project_root / "assets"
    output_dir = args.output_dir if args.output_dir is not None else project_root / "src" / "generated"
